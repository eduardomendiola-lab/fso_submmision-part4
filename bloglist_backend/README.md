...
NB when you are comparing objects, the deepStrictEqual method is probably what you want to use, as it ensures that the objects have the same attributes. For differences between various assert module functions, you can refer to this Stack Overflow answer.
...
app.use('/api/blogs', middleware.userExtractor, blogsRouter)app
